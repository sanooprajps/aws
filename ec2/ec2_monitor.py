...
# AWS response contains datetime where json can't understand this. 
    ...
    print (response_json['Reservations'][0]['Instances']['InstanceId'])
#    print ("EC2 instance summary received. Number of instance available :- {}".format(response_json['Reservations'][0]['Instances']['InstanceId']))
